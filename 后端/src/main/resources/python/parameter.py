...
def parse_args():
    ...
    # word2vec
    parser.add_argument('--WORD2VEC_DIR', default='333.pickle')

    # dataset
    parser.add_argument('--train_size', default=1000,  type=int,   help='training set size')# 1000
    parser.add_argument('--test_size',  default=246,   type=int,   help='testing set size')# 246
    parser.add_argument('--num_class',  default=6,     type=int,   help='number of classes')

    # model arguments
    parser.add_argument('--in_dim',     default=100,   type=int,   help='size of input word vector')# 300
    parser.add_argument('--h_dim',      default=200,   type=int,   help='size of hidden unit')# 300
